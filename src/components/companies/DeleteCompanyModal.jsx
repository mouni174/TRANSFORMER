...
export const DeleteCompanyModal = ({ isOpen, company, onClose, onConfirm, isDeleting }) => {
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="p-5 border-b border-slate-100 flex items-start space-x-3 bg-red-50/50">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-bold text-slate-900">Confirm Company Deletion</h3>
        ...
        <div className="p-5 space-y-3 text-xs text-slate-700">
          ...
          <div className="p-3 bg-amber-50 border border-amber-200 rounded-md text-amber-800 text-[11px] leading-relaxed">
            ...
            Deleting this company will permanently remove the company entity. Any associated transformer units and historical oil service records stored under this company will also be removed per database foreign key constraints.
          </div>
        </div>
